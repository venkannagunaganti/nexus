...
folder_path = 'C:/Users/vgunaganti/PycharmProjects/match/Jobs'
...
def main(app_name, folder_path, verbose=False, count=False):
...
p2='C:/Users/vgunaganti/PycharmProjects/match/Jobs/dnf.txt'
def dnf_to_excel(p2):
        new_dict=[]
        ...
        df.replace('\x01', '', regex=True, inplace=True)
        df.to_excel(path,sheet_name='dnf', index=False)
